...
cp /root/NeXt-Server-Bullseye/includes/NeXt-logo.jpg /var/www/${MYDOMAIN}/public/NeXt-logo.jpg
cp /root/NeXt-Server-Bullseye/configs/nginx/index.html /var/www/${MYDOMAIN}/public/index.html
}
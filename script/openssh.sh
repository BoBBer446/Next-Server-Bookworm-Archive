...
cp /root/NeXt-Server-Bookworm/configs/sshd_config /etc/ssh/sshd_config
cp /root/NeXt-Server-Bookworm/includes/issue /etc/issue
cp /root/NeXt-Server-Bookworm/includes/issue.net /etc/issue.net
...
echo "$SSH_PORT" >> /root/NeXt-Server-Bookworm/configs/blocked_ports.conf

echo "#------------------------------------------------------------------------------#" >> /root/NeXt-Server-Bookworm/login_information.txt
echo "#SSH_PORT: ${SSH_PORT}" >> /root/NeXt-Server-Bookworm/login_information.txt
echo "#------------------------------------------------------------------------------#" >> /root/NeXt-Server-Bookworm/login_information.txt
echo "" >> /root/NeXt-Server-Bookworm/login_information.txt
...
echo "#------------------------------------------------------------------------------#" >> /root/NeXt-Server-Bookworm/login_information.txt
echo "#SSH_PASS: ${SSH_PASS}" >> /root/NeXt-Server-Bookworm/login_information.txt
echo "#------------------------------------------------------------------------------#" >> /root/NeXt-Server-Bookworm/login_information.txt
echo "" >> /root/NeXt-Server-Bookworm/login_information.txt

...
echo "RSPAMADM URL: https://${MYDOMAIN}/rspamd/" >> /root/NeXt-Server-Bullseye/login_information.txt
echo "#------------------------------------------------------------------------------#" >> /root/NeXt-Server-Bullseye/login_information.txt
echo "" >> /root/NeXt-Server-Bullseye/login_information.txt

echo "#------------------------------------------------------------------------------#" >> /root/NeXt-Server-Bullseye/login_information.txt
echo "RSPAMADM_PASSWORT: $RSPAMADM_PASSWORT" >> /root/NeXt-Server-Bullseye/login_information.txt
echo "#------------------------------------------------------------------------------#" >> /root/NeXt-Server-Bullseye/login_information.txt
echo "" >> /root/NeXt-Server-Bullseye/login_information.txt
...
cp /var/lib/rspamd/dkim/${CURRENT_YEAR}.txt /root/NeXt-Server-Bullseye/DKIM_KEY_ADD_TO_DNS.txt

cp /root/NeXt-Server-Bullseye/configs/rspamd/dkim_signing.conf /etc/rspamd/local.d/dkim_signing.conf
...
cp /root/NeXt-Server-Bullseye/configs/rspamd/redis.conf /etc/rspamd/local.d/redis.conf
...
echo "#------------------------------------------------------------------------------#" >> /root/NeXt-Server-Bullseye/login_information.txt
echo "Redis Password: ${REDIS_PASSWORT}" >> /root/NeXt-Server-Bullseye/login_information.txt
echo "#------------------------------------------------------------------------------#" >> /root/NeXt-Server-Bullseye/login_information.txt
echo "" >> /root/NeXt-Server-Bullseye/login_information.txt

cp /root/NeXt-Server-Bullseye/configs/mailserver/_rspamd.conf /etc/nginx/_rspamd.conf

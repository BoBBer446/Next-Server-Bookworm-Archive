...
cp /root/NeXt-Server-Bullseye/configs/roundcube/config.inc.php /var/www/${MYDOMAIN}/public/webmail/config/config.inc.php
...
echo "Roundcube Webmail URL: https://${MYDOMAIN}/webmail/" >> /root/NeXt-Server-Bullseye/login_information.txt
echo "#------------------------------------------------------------------------------#" >> /root/NeXt-Server-Bullseye/login_information.txt
echo "#------------------------------------------------------------------------------#" >> /root/NeXt-Server-Bullseye/login_information.txt
echo "ROUND_HTTPAUTH_USER = ${ROUND_HTTPAUTH_USER}" >> /root/NeXt-Server-Bullseye/login_information.txt
echo "ROUND_HTTPAUTH_PASS = ${ROUND_HTTPAUTH_PASS}" >> /root/NeXt-Server-Bullseye/login_information.txt
echo "ROUNDCUBEDBUser = ${ROUNDCUBE_USER}" >> /root/NeXt-Server-Bullseye/login_information.txt
echo "ROUNDCUBEDBName = ${ROUNDCUBE_DB_NAME}" >> /root/NeXt-Server-Bullseye/login_information.txt
echo "ROUNDCUBEDBPassword = ${ROUNDCUBE_DB_PASS}" >> /root/NeXt-Server-Bullseye/login_information.txt
echo "DES_KEY = ${RANDOM_DESKEY}" >> /root/NeXt-Server-Bullseye/login_information.txt
echo "Disable the http auth?" >> /root/NeXt-Server-Bullseye/login_information.txt
echo "Open /etc/nginx/sites-available/${MYDOMAIN}.conf and delete the lines:" >> /root/NeXt-Server-Bullseye/login_information.txt

...
cp /root/NeXt-Server-Bookworm/configs/roundcube/config.inc.php /var/www/${MYDOMAIN}/public/webmail/config/config.inc.php
...
echo "Roundcube Webmail URL: https://${MYDOMAIN}/webmail/" >> /root/NeXt-Server-Bookworm/login_information.txt
echo "#------------------------------------------------------------------------------#" >> /root/NeXt-Server-Bookworm/login_information.txt
echo "#------------------------------------------------------------------------------#" >> /root/NeXt-Server-Bookworm/login_information.txt
echo "ROUND_HTTPAUTH_USER = ${ROUND_HTTPAUTH_USER}" >> /root/NeXt-Server-Bookworm/login_information.txt
echo "ROUND_HTTPAUTH_PASS = ${ROUND_HTTPAUTH_PASS}" >> /root/NeXt-Server-Bookworm/login_information.txt
echo "ROUNDCUBEDBUser = ${ROUNDCUBE_USER}" >> /root/NeXt-Server-Bookworm/login_information.txt
echo "ROUNDCUBEDBName = ${ROUNDCUBE_DB_NAME}" >> /root/NeXt-Server-Bookworm/login_information.txt

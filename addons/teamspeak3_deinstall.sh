...
rm /root/NeXt-Server-Bullseye/teamspeak3_login_data.txt
...
sed_replace_word "TS3_IS_INSTALLED=\"1"\" "TS3_IS_INSTALLED=\"0"\" "/root/NeXt-Server-Bullseye/configs/userconfig.cfg"
}